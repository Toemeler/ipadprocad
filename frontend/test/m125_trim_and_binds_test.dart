// M125 — three device reports from the 2026-08-04 session, all in 2D mode.
//
...
void main() {
  group('M125/1 — a tangency is an intersection, and only ONE', () {
  ...
  group('M125/2 — inference binds in BOTH directions', () {
  ...
  group('M125/3 — Trim keeps the carrier as construction geometry', () {
