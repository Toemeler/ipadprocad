...
// The marker. `used` so the linker cannot drop an object nothing references;
// no visibility attribute, because the version script already makes everything
// that is not one of the three C-API prefixes local, and an attribute here
