// Prototype — Dart FFI usage example (mirrors the native C smoke test).
//
...
//   dart run example/qcad_smoke.dart /path/to/libprototype.so
//
...
void main(List<String> args) {
  ...
  final path = '${Directory.systemTemp.path}/prototype_dart_smoke.dxf';
